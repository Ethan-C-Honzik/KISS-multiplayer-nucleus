...
local function handle_file_transfer(data)
  ...
  local file_len = butesToU32(data:sub(1, 4))
...
local function onUpdate(dt)
  ...
  while true do
    ...
    elseif string.byte(msg_type) == 0 then -- Binary data
      ...
      local chunk_n = butesToU32(chunk_n_b)
      local chunk_a = butesToU32(chunk_a_b)
      local read_size = butesToU32(read_size_b)
